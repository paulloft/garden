...
abstract class SqlDriver {
     ...
     * @return DataSet The data returned by the query.
     */
     ...
     * @see DatabaseDriver::WhereExists()
     * @see DatabaseDriver::WhereNotExists()
     */
     ...
     *    and concatenates with an 'or.'
     * @see DatabaseDriver::WhereIn()
     * @see DatabaseDriver::WhereNotIn()
     */
     ...
     * @param DatabaseDriver $SqlDriver The sql to add.
